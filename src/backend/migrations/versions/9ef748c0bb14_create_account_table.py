...
Revision ID: 9ef748c0bb14
Revises: 
Create Date: 2024-03-22 19:39:35.517423
...
def upgrade():
    ...
    op.create_index(op.f('ix_test_run_performer_id'), 'test_run', ['performer_id'], unique=False)
    ...
    op.create_table('list_execution',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('check_list_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_list_execution_check_list_id'), 'list_execution', ['check_list_id'], unique=False)
    op.create_index(op.f('ix_list_execution_test_run_id'), 'list_execution', ['test_run_id'], unique=False)
    ...
    op.create_index(op.f('ix_test_execution_test_run_id'), 'test_execution', ['test_run_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_test_execution_test_run_id'), table_name='test_execution')
    ...
    op.drop_index(op.f('ix_list_execution_test_run_id'), table_name='list_execution')
    op.drop_index(op.f('ix_list_execution_check_list_id'), table_name='list_execution')
    op.drop_table('list_execution')
    ...
    op.drop_index(op.f('ix_test_run_performer_id'), table_name='test_run')
